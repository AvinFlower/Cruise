...
using (TourContext db = new())
{
    ...
    passenger1.Add("Динисов", "Антон", "Викторович", "3318600467", new DateOnly(2003, 09, 06), Grachdanstvo.RF.ToString(), "1", "1");
    db.Passes.Add(passenger1);

    Passenger passenger2 = new Passenger();
    passenger2.Add("Васильева", "Ольга", "Павловна", "3128470467", new DateOnly(2000, 10, 26), Grachdanstvo.RF.ToString(), "2", "2");
    db.Passes.Add(passenger2);

    Passenger passenger3 = new Passenger();
    passenger3.Add("Кузнецов", "Андрей", "Владимирович", "334600467", new DateOnly(1999, 12, 06), Grachdanstvo.RF.ToString(), "3", "3");
    db.Passes.Add(passenger3);

    Passenger passenger4 = new Passenger();
    passenger4.Add("Зайцев", "Елена", "Ивановна", "3313400467", new DateOnly(1985, 10, 16), Grachdanstvo.RF.ToString(), "4", "4");
    db.Passes.Add(passenger4);

    Passenger passenger5 = new Passenger();
    passenger5.Add("Павлов", "Сергей", "Алексеевич", "3313500467", new DateOnly(1989, 11, 06), Grachdanstvo.RF.ToString(), "5", "5");
    db.Passes.Add(passenger5);

    Passenger passenger6 = new Passenger();
    passenger6.Add("Новиков", "Артем", "Игоревич", "3313400466", new DateOnly(1995, 05, 22), Grachdanstvo.RF.ToString(), "6", "6");
    db.Passes.Add(passenger6);

    Passenger passenger7 = new Passenger();
    passenger7.Add("Игнатьева", "Татьяна", "Александровна", "3233400467", new DateOnly(1975, 11, 26), Grachdanstvo.RF.ToString(), "7", "7");
    db.Passes.Add(passenger7);

    Passenger passenger8 = new Passenger();
    passenger8.Add("Жуков", "Виктор", "Владимирович", "3563400467", new DateOnly(1965, 11, 06), Grachdanstvo.RF.ToString(), "8", "8");
    db.Passes.Add(passenger8);

    Passenger passenger9 = new Passenger();
    passenger9.Add("Костин", "Максим", "Сергеевич", "3313407867", new DateOnly(1975, 11, 03), Grachdanstvo.RF.ToString(), "9", "9");
    db.Passes.Add(passenger9);

    Passenger passenger10 = new Passenger();
    passenger10.Add("Федоров", "Людмила", "Петровна", "3453400467", new DateOnly(1995, 04, 12), Grachdanstvo.RF.ToString(), "10", "10");
    ...
    admin1.Add("admin2", "345", "Люсьеныч", "");
